...
CREATE TABLE users_chats (
	...
	CONSTRAINT fk_users_chats_chats FOREIGN KEY(user_id) REFERENCES users(id),
	CONSTRAINT fk_users_chats_users FOREIGN KEY(chat_id) REFERENCES chats(id)
);